   ...
   <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="9" r="3"/><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"/></g></symbol>
    ...
    <section class='mt-5 mb-5'>
     <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <form class="shadow p-4" id="contactForm">
              <div class="form-group">
                <input type="text" class="form-control mb-3" id="name" placeholder="Enter full name" required>
              </div>
              <div class="form-group">
                <input type="email" class="form-control mb-3" id="email" aria-describedby="emailHelp" placeholder="Enter email" required>
              </div>
              <div class="form-group">
                <input type="number" class="form-control mb-3" id="phone" placeholder="Phone no." required>
              </div>
              <div class="form-group">
            ...
            <script>
              document.getElementById('contactForm').addEventListener('submit', function (event) {
                ...
                var message = `Hello, I would like to share the following details:\n\n` +
                              `Name: ${name}\n` +
                              `Email: ${email}\n` +
                              `Phone: ${phone}\n` +
                              `Address: ${address}`;
                ...
                var whatsappUrl = `https://wa.me/919696860365?text=${encodedMessage}`;
          ...
          <div class="col-md-6">
            <div class="shadow">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3032.402995549357!2d83.00624432783069!3d25.332572010236877!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398e2e133ab4a06b%3A0xa593d881311f8e24!2sj%2C%2021%2F41%2C%20Rasoolpura%2C%20Bunker%20Colony%2C%20Alaipura%2C%20Jaitpura%2C%20Varanasi%2C%20Uttar%20Pradesh%20221001!5e0!3m2!1sen!2sin!4v1733994855067!5m2!1sen!2sin" width="100%" height="290" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  
            </div>
          </div>
        </div>
     </div>
