...
<html lang="en">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" id="offers" viewBox="0 0 48 48"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m41.556 39.297l-22.022 3.11a1.097 1.097 0 0 1-1.245-.97l-2.352-22.311a1.097 1.097 0 0 1 1.08-1.213l24.238-.229a1.097 1.097 0 0 1 1.108 1.09l.137 19.429c.004.55-.4 1.017-.944 1.094M26.1 25.258v2.579m8.494-2.731v2.175"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.343 32.346c-1.437.828-1.926 1.198-2.774 1.988c-1.19-.457-2.284-1.228-3.797-1.456m-15.953 8.721l-3.49-1.6a1.12 1.12 0 0 1-.643-.863L5.511 23.593c-.056-.4.108-.8.43-1.046l3.15-2.406a1.257 1.257 0 0 1 2.014.874l1.966 19.69a.887.887 0 0 1-1.252.894m11.989-28.112c.214-.456.964-1.716 2.76-3.618c3.108-3.323 4.26-4.288 4.26-4.288s1.42.75 3.27 3.109c1.876 2.358 1.93 3.832 1.93 3.832s.67-.08-4.797 1.688c-3.055.991-4.368 1.152-4.931 1.152"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.97 17.828v-.054c0-.884-.241-1.715-.67-2.412c-.563-.91-1.447-1.608-2.492-1.876a3.58 3.58 0 0 0-1.072-.16c-.429 0-.858.053-1.233.214c-1.152.348-2.063 1.18-2.573 2.278a4.747 4.747 0 0 0-.428 1.956v.134"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.93 15.818c-.562-.107-1.5-.349-3.135-.884c-2.304-.75-3.43-1.528-3.43-1.528s-.456-1.393 1.045-3.296s2.653-2.52 2.653-2.52s.911.778 3.43 3.485c1.26 1.313 1.796 2.09 2.01 2.465h.027"/></symbol>
   ...
   <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="9" r="3"/><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"/></g></symbol>
    ...
    <p>At <strong>Shameema Sarees</strong>, customer satisfaction is our priority. We understand that sometimes plans change, and you may need to cancel or return your purchase. This Cancellation and Refund Policy outlines the conditions under which cancellations and refunds are accepted to ensure a seamless shopping experience for our customers.</p>
    
    <hr />
    
    <h2>1. Order Cancellation</h2>
    <ul>
      <li><strong>Before Dispatch:</strong>  
        You can cancel your order before it has been dispatched by contacting us at <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a> or calling us at +91-9696860365. A full refund will be processed for orders canceled before dispatch.
      </li>
      <li><strong>After Dispatch:</strong>  
        Orders cannot be canceled once they have been dispatched. However, you may be eligible for a return or exchange (refer to the Return Policy section).
      </li>
    </ul>
    ...
    <ul>
      <li><strong>Eligibility for Returns:</strong>  
        You can request a return if the product meets the following conditions:
        <ul>
          <li>The product is defective, damaged, or incorrect.</li>
          <li>The return request is raised within <strong>7 days</strong> of receiving the order.</li>
        </ul>
      </li>
      <li><strong>Non-Returnable Items:</strong>  
        The following items are not eligible for return:
        <ul>
          <li>Products that have been used, washed, or altered.</li>
          <li>Items purchased during sales, promotions, or with a discount.</li>
          <li>Customized or personalized sarees.</li>
        </ul>
      </li>
      <li><strong>Return Process:</strong>  
        <ol>
          <li>Contact our support team at <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a> within 7 days of receiving the product.</li>
          <li>Provide your order details and images of the defective or incorrect item for verification.</li>
          <li>Once approved, our team will guide you through the return process.</li>
        </ol>
      </li>
    </ul>
    ...
    <ul>
      <li><strong>Refund Eligibility:</strong>  
        Refunds are issued for returned items that meet our eligibility criteria. Once the returned product is inspected and approved, the refund process will be initiated.
      </li>
      <li><strong>Refund Methods:</strong>  
        Refunds will be credited using the original payment method within <strong>7-10 business days</strong> after approval.
      </li>
      <li><strong>Partial Refunds:</strong>  
        Partial refunds may apply if:
        <ul>
          <li>The returned item is found to be used or altered.</li>
          <li>The item is returned beyond the specified time frame.</li>
        </ul>
      </li>
      <li><strong>Shipping Fees:</strong>  
        Shipping charges are non-refundable unless the return is due to an error on our part (e.g., defective or incorrect item).
      </li>
    </ul>
    
    <h2>4. Exchange Policy</h2>
    <p>We do not offer direct exchanges. You may return the product for a refund and place a new order for the desired item.</p>
    
    <h2>5. Important Notes</h2>
    <ul>
      <li>Always ensure the product is packed securely to avoid damage during return transit.</li>
    ...
    <h2>Contact Us</h2>
    <p>For further assistance regarding cancellations, returns, or refunds, please contact us:</p>
    <p><strong>Email:</strong> <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a></p>
    <p><strong>Phone:</strong> +91-9696860365</p>
    <p><strong>Address:</strong> J 21/47 Rasoolpura Jaitpura, Varanasi-221001, Uttar Pradesh, INDIA</p>
    
    <p>We at <strong>Shameema Sarees</strong> strive to ensure a hassle-free shopping experience and appreciate your trust in us.</p>
