...
<html lang="en">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" id="offers" viewBox="0 0 48 48"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m41.556 39.297l-22.022 3.11a1.097 1.097 0 0 1-1.245-.97l-2.352-22.311a1.097 1.097 0 0 1 1.08-1.213l24.238-.229a1.097 1.097 0 0 1 1.108 1.09l.137 19.429c.004.55-.4 1.017-.944 1.094M26.1 25.258v2.579m8.494-2.731v2.175"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.343 32.346c-1.437.828-1.926 1.198-2.774 1.988c-1.19-.457-2.284-1.228-3.797-1.456m-15.953 8.721l-3.49-1.6a1.12 1.12 0 0 1-.643-.863L5.511 23.593c-.056-.4.108-.8.43-1.046l3.15-2.406a1.257 1.257 0 0 1 2.014.874l1.966 19.69a.887.887 0 0 1-1.252.894m11.989-28.112c.214-.456.964-1.716 2.76-3.618c3.108-3.323 4.26-4.288 4.26-4.288s1.42.75 3.27 3.109c1.876 2.358 1.93 3.832 1.93 3.832s.67-.08-4.797 1.688c-3.055.991-4.368 1.152-4.931 1.152"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.97 17.828v-.054c0-.884-.241-1.715-.67-2.412c-.563-.91-1.447-1.608-2.492-1.876a3.58 3.58 0 0 0-1.072-.16c-.429 0-.858.053-1.233.214c-1.152.348-2.063 1.18-2.573 2.278a4.747 4.747 0 0 0-.428 1.956v.134"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.93 15.818c-.562-.107-1.5-.349-3.135-.884c-2.304-.75-3.43-1.528-3.43-1.528s-.456-1.393 1.045-3.296s2.653-2.52 2.653-2.52s.911.778 3.43 3.485c1.26 1.313 1.796 2.09 2.01 2.465h.027"/></symbol>
   ...
   <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="9" r="3"/><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"/></g></symbol>
    ...
    <p>At <strong>Shameema Sarees</strong>, we are committed to delivering your products safely and on time. This Shipping and Delivery Policy outlines the details of our shipping process to provide you with clarity and transparency regarding your order's journey from our store to your doorstep.</p>
    
    <hr />
    
    <h2>1. Shipping Locations</h2>
    <ul>
      <li>We ship our products across India.</li>
      <li>Currently, international shipping is not available.</li>
    </ul>
    ...
    <ul>
      <li><strong>Standard Shipping:</strong> Delivery typically takes <strong>5-7 business days</strong> depending on your location.</li>
      <li><strong>Remote Areas:</strong> Delivery to remote areas may take <strong>7-10 business days</strong>.</li>
    </ul>
    
    <h2>4. Shipping Charges</h2>
    <ul>
      <li><strong>Free Shipping:</strong> We offer free shipping on orders above ₹999.</li>
      <li>For orders below ₹999, a flat shipping fee of ₹50 will apply.</li>
    </ul>
    
    <h2>5. Order Tracking</h2>
    <p>Once your order has been dispatched, you will receive a tracking number via email or SMS. Use the tracking details provided to monitor your shipment’s progress in real time.</p>
    
    <h2>6. Delivery Terms</h2>
    <ul>
      <li>Deliveries are made to the address provided during checkout. Please ensure all details are accurate to avoid delays.</li>
      <li>If the delivery fails due to an incorrect or incomplete address, additional charges may apply for re-delivery.</li>
    </ul>
    
    <h2>7. Damaged or Missing Items</h2>
    <p>If you receive a damaged package or if items are missing, please notify us within <strong>48 hours</strong> of delivery by emailing us at <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a>. Include photographs of the package and its contents for quick resolution.</p>
    
    <h2>8. Undelivered Orders</h2>
    <p>If an order cannot be delivered due to customer unavailability, it may be returned to us. You can request a re-delivery, but additional charges may apply.</p>
    
    <h2>9. Changes to Delivery Address</h2>
    <p>Address changes can be made before the order is dispatched. Contact our support team at <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a> or call us at +91-9696860365 for assistance.</p>
    
    <h2>10. Delayed Shipments</h2>
    <p>We strive to deliver your order on time; however, delays may occur due to unforeseen circumstances such as natural disasters, courier service disruptions, or regional restrictions. In case of significant delays, our support team will keep you informed and assist you in tracking your order.</p>
    
    <h2>11. Contact Us</h2>
    <p>For any questions or concerns regarding shipping and delivery, feel free to reach out to us:</p>
    <ul>
      <li><strong>Email:</strong> <a href="mailto:shameemasarees@gmail.com">shameemasarees@gmail.com</a></li>
      <li><strong>Phone:</strong> +91-9696860365</li>
      <li><strong>Address:</strong> J 21/47 Rasoolpura Jaitpura, Varanasi-221001, Uttar Pradesh, INDIA</li>
    </ul>
    
    <p>We are dedicated to providing a smooth shopping experience and ensuring your products reach you in perfect condition.</p>
