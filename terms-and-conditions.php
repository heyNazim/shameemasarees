...
<html lang="en">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" id="offers" viewBox="0 0 48 48"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m41.556 39.297l-22.022 3.11a1.097 1.097 0 0 1-1.245-.97l-2.352-22.311a1.097 1.097 0 0 1 1.08-1.213l24.238-.229a1.097 1.097 0 0 1 1.108 1.09l.137 19.429c.004.55-.4 1.017-.944 1.094M26.1 25.258v2.579m8.494-2.731v2.175"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M34.343 32.346c-1.437.828-1.926 1.198-2.774 1.988c-1.19-.457-2.284-1.228-3.797-1.456m-15.953 8.721l-3.49-1.6a1.12 1.12 0 0 1-.643-.863L5.511 23.593c-.056-.4.108-.8.43-1.046l3.15-2.406a1.257 1.257 0 0 1 2.014.874l1.966 19.69a.887.887 0 0 1-1.252.894m11.989-28.112c.214-.456.964-1.716 2.76-3.618c3.108-3.323 4.26-4.288 4.26-4.288s1.42.75 3.27 3.109c1.876 2.358 1.93 3.832 1.93 3.832s.67-.08-4.797 1.688c-3.055.991-4.368 1.152-4.931 1.152"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M26.97 17.828v-.054c0-.884-.241-1.715-.67-2.412c-.563-.91-1.447-1.608-2.492-1.876a3.58 3.58 0 0 0-1.072-.16c-.429 0-.858.053-1.233.214c-1.152.348-2.063 1.18-2.573 2.278a4.747 4.747 0 0 0-.428 1.956v.134"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M18.93 15.818c-.562-.107-1.5-.349-3.135-.884c-2.304-.75-3.43-1.528-3.43-1.528s-.456-1.393 1.045-3.296s2.653-2.52 2.653-2.52s.911.778 3.43 3.485c1.26 1.313 1.796 2.09 2.01 2.465h.027"/></symbol>
   ...
   <symbol xmlns="http://www.w3.org/2000/svg" id="user" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="9" r="3"/><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5"/></g></symbol>
    ...
    <p>Welcome to <strong>Shameema Sarees</strong>!</p>
    
    <p>By browsing and shopping on our website, you agree to abide by the terms and conditions outlined here. We encourage you to read these terms carefully to ensure clarity and transparency in our relationship with you.</p>
    
    <p>If you find any of these terms unacceptable, kindly refrain from using our website or services.</p>
    
    <h2>Age Restriction</h2>
    <p>To make a purchase on <strong>Shameema Sarees</strong>, you must be at least 18 years old. By proceeding with an order, you confirm that you meet this age requirement and have the legal capacity to enter into a binding agreement.</p>
    
    <h2>Product Information</h2>
    <p>We put significant effort into presenting our products with accurate descriptions and imagery. However, slight differences in appearance (e.g., color, texture) may arise due to screen settings or lighting conditions. We recommend reviewing the product details thoroughly before completing your purchase.</p>
    
    <h2>Returns and Refunds</h2>
    <p>We stand behind the quality of our products. If you receive an item that is defective or damaged, you may initiate a return. Refunds will only be processed after the returned product has been received and reviewed. For complete details, please visit our <a href="/return-policy">Return Policy</a> page.</p>
    
    <h2>Your Responsibilities</h2>
    <ul>
      <li>Ensure that the information provided during the checkout process is accurate and complete.</li>
      <li>Use the website and services responsibly and in compliance with applicable laws and regulations.</li>
    </ul>
    
    <h2>Intellectual Property</h2>
    <p>The content on <strong>Shameema Sarees</strong>, including images, logos, designs, and text, is the exclusive property of our company. Reproducing, copying, or distributing any material without prior written consent is prohibited.</p>
    
    <h2>Liability Limitations</h2>
    <p>While we aim to provide a seamless shopping experience, our liability is strictly limited to the amount paid for the purchased item in cases of dispute or claim.</p>
    
    <h2>Policy Updates</h2>
    <p><strong>Shameema Sarees</strong> reserves the right to revise these terms and conditions as necessary. Any updates will take effect immediately upon posting. We encourage you to review this section periodically to stay informed of any changes.</p>
    
    <p>Thank you for shopping with <strong>Shameema Sarees</strong>, where tradition meets elegance!</p>
