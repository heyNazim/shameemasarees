      ...
      <html lang="en">
        <head>
          <title>Banarasi Silk Saree Shop in Varanasi: Pure & Original</title>
          <meta charset="utf-8">
...
<section class="py-5 overflow-hidden">
   <div class="container-lg">
      <div class="row">
         <div class="col-md-12">
            <div class="section-header d-flex flex-wrap justify-content-between mb-2">
               <h2 class="section-title mt-5">All Sarees</h2>
               <div class="d-flex align-items-center">
                  <a href="./all-sarees.php" class="btn btn-primary me-2">View All</a>
      ...
      <div class="row">
         <div class="col-md-12">
            <!-- Swiper container for All Sarees -->
          ...
          <section class="mb-5">
            <div class="container-lg">
              <div class="row">
                ...
                <div class="col-md-7"> 
                  <img src="./images/newarrivalbanner.webp" class="img-fluid shadow" alt="">
                </div>

                <div class="col-md-5"> 
                  <!-- <img src="./images/newarriproducts1.webp" class="img-fluid shadow" alt=""> -->
                  <img src="./images/newarrSaree-Banner.webp" class="img-fluid shadow" alt="">
                </div>
...
<!-- vedio sec -->
          <?php     include('./components/vedio.php');    ?>
<!-- vedio sec end -->
  

<!-- What we offer -->
          <?php     include('./components/what-we-offer.php');    ?>
<!-- What we offer end -->
